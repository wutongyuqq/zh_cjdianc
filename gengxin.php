...
pdo_query("ALTER TABLE " . tablename('cjdc_sms') . " CHANGE `yy_tid` `yy_tid` varchar(20) NOT NULL");
pdo_query("ALTER TABLE " . tablename('cjdc_sms') . " CHANGE `wm_tid` `wm_tid` varchar(20) NOT NULL");
pdo_query("ALTER TABLE " . tablename('cjdc_sms') . " CHANGE `dn_tid` `dn_tid` varchar(20) NOT NULL");
