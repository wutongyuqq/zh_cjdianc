...
pdo_query("CREATE TABLE IF NOT EXISTS" . tablename('cjdc_service_pay') . "(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS" . tablename('cjdc_sssset') . "(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
if (!pdo_fieldexists(tablename('cjdc_store'), 'store_mchid')) {
...
if (!pdo_fieldexists(tablename('cjdc_message'), 'shtk_tid')) {
...
if (!pdo_fieldexists(tablename('cjdc_system'), 'is_pay')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `is_pay` INT( 1 ) NOT NULL DEFAULT  '2'");
}

if (!pdo_fieldexists(tablename('cjdc_system'), 'pay_money')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `pay_money` DECIMAL( 10, 2 ) NOT NULL DEFAULT  '0.00'");
}

if (!pdo_fieldexists(tablename('cjdc_message'), 'aliyun_appkey')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `aliyun_appkey` VARCHAR( 20 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'aliyun_appsecret')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `aliyun_appsecret` VARCHAR( 50 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'aliyun_sign')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `aliyun_sign` VARCHAR( 20 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'aliyun_id')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `aliyun_id` VARCHAR( 20 ) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_sms'), 'aliyun_appkey')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `aliyun_appkey` VARCHAR( 20 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_sms'), 'aliyun_appsecret')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `aliyun_appsecret` VARCHAR( 50 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_sms'), 'aliyun_sign')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `aliyun_sign` VARCHAR( 20 ) NOT NULL");
}

if (!pdo_fieldexists(tablename('zhtc_sms'), 'aliyun_appkey')) {
	pdo_query("ALTER TABLE" . tablename('zhtc_sms') . " ADD `aliyun_appkey` VARCHAR( 20 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('zhtc_sms'), 'aliyun_appsecret')) {
	pdo_query("ALTER TABLE" . tablename('zhtc_sms') . " ADD `aliyun_appsecret` VARCHAR( 50 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('zhtc_sms'), 'aliyun_sign')) {
	pdo_query("ALTER TABLE" . tablename('zhtc_sms') . " ADD `aliyun_sign` VARCHAR( 20 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('zhtc_sms'), 'item')) {
	pdo_query("ALTER TABLE" . tablename('zhtc_sms') . " ADD `item` INT(4) NOT NULL DEFAULT '1'");
}
if (!pdo_fieldexists(tablename('cjdc_goods'), 'is_max')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_goods') . " ADD `is_max` INT( 1 ) NOT NULL DEFAULT  '2'");
}
if (!pdo_fieldexists(tablename('cjdc_system'), 'is_vip_delivery')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `is_vip_delivery` INT( 1 ) NOT NULL DEFAULT  '2'");
}
if (!pdo_fieldexists(tablename('cjdc_storeset'), 'full_delivery')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_storeset') . " ADD `full_delivery` INT( 11 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'group_tid')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `group_tid` VARCHAR( 50 ) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'rush_tid')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `rush_tid` VARCHAR( 50 ) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_storeset'), 'is_poundage')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_storeset') . " ADD `is_poundage` INT( 1 ) NOT NULL DEFAULT  '2'");
}
if (!pdo_fieldexists(tablename('cjdc_storeset'), 'dn_poundage')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_storeset') . " ADD `dn_poundage`  VARCHAR(20) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_storeset'), 'dm_poundage')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_storeset') . " ADD `dm_poundage`  VARCHAR(20) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_storeset'), 'yd_poundage')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_storeset') . " ADD `yd_poundage`  VARCHAR(20) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_sms'), 'is_tk')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `is_tk` INT( 1 ) NOT NULL DEFAULT  '2'");
}
if (!pdo_fieldexists(tablename('cjdc_sms'), 'tk_tid')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `tk_tid`  VARCHAR(30) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_order'), 'oid')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_order') . " ADD `oid`  INT( 11 ) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_message'), 'wechat_appId')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `wechat_appId` VARCHAR(50) NOT NULL");
}
if (!pdo_fieldexists(tablename('cjdc_message'), 'wechat_appsecret')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `wechat_appsecret` VARCHAR(100) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_message'), 'wechat_wm_tid')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_message') . " ADD `wechat_wm_tid` VARCHAR(100) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_sms'), 'openId')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_sms') . " ADD `openId` VARCHAR(100) NOT NULL");
}

if (!pdo_fieldexists(tablename('cjdc_system'), 'is_tel')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `is_tel` INT( 1 ) NOT NULL DEFAULT  '2' ");
}
if (!pdo_fieldexists(tablename('cjdc_system'), 'is_yy')) {
	pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `is_yy` INT( 1 ) NOT NULL DEFAULT  '1' ");
}

if (!pdo_fieldexists(tablename('cjdc_system'), 'is_sss')) {
  pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `is_sss` INT( 1 ) NOT NULL DEFAULT  '1' ");
}
if (!pdo_fieldexists(tablename('cjdc_system'), 'sss_appkey')) {
  pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `sss_appkey` VARCHAR(50) NOT NULL  ");
}
if (!pdo_fieldexists(tablename('cjdc_system'), 'sss_secret')) {
  pdo_query("ALTER TABLE" . tablename('cjdc_system') . " ADD `sss_secret` VARCHAR(50) NOT NULL  ");
}

if (!pdo_fieldexists(tablename('cjdc_order'), 'sss_peisong_id')) {
  pdo_query("ALTER TABLE" . tablename('cjdc_order') . " ADD `sss_peisong_id` VARCHAR(32) NOT NULL  ");
}

pdo_query("ALTER TABLE " . tablename('cjdc_store') . " ADD INDEX (  `uniacid` ) ;");
pdo_query("ALTER TABLE " . tablename('cjdc_storeset') . " ADD INDEX (  `store_id` ) ;");
pdo_query("ALTER TABLE " . tablename('cjdc_distribution') . " ADD INDEX (  `store_id` ) ;");
pdo_query("ALTER TABLE " . tablename('cjdc_reduction') . " ADD INDEX (  `store_id` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order') . " ADD INDEX (  `user_id` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order') . " ADD INDEX (  `store_id` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order') . " ADD INDEX (  `state` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order') . " ADD INDEX (  `order_type` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order') . " ADD INDEX (  `uniacid` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_goods') . " ADD INDEX (  `store_id` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_goods') . " ADD INDEX (  `type_id` )  ;");
pdo_query("ALTER TABLE " . tablename('cjdc_order_goods') . " ADD INDEX (  `order_id` )  ;");

// if (!pdo_fieldexists(tablename('cjdc_order'), 'old_money')) {
//     pdo_query("ALTER TABLE".tablename('cjdc_order')." ADD `old_money` DECIMAL(10,2) NOT NULL");
// }
