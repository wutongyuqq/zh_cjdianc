		...
		if ($_W['role'] == 'operator') {
			...
			$navemenu[2] = array(
				...
				'items' => array(
			        ...
			        3 => $this->createMainMenu('赠品管理 ', $do, 'shop', ''),
			        4 => $this->createMainMenu('赠品列表 ', $do, 'zengpinglist', ''),
				),
			);
			$navemenu[3] = array(
		...
		if ($_W['isfounder'] || $_W['role'] == 'manager' || $_W['role'] == 'operator') {
			...
			$navemenu[1] = array(
				...
				'items' => array(
					...
					5 => $this->createMainMenu('充值记录', $do, 'addmoney', ''),
			...
			if ($system['qggn'] == 1) {
				$navemenu[12] = array(
					...
					'items' => array(
						...
						2 => $this->createMainMenu('充值记录 ', $do, 'addmoney', ''),
					),
				);
			}
			if ($system['ptgn'] == 1) {
